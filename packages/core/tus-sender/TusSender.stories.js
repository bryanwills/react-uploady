...
export const WithTusSender: UploadyStory = createUploadyStory((props): Element<"div"> => {
...
export const WithTusDataOnCreate: UploadyStory = createUploadyStory((props): Element<"div"> => {
    const inputRef = useRef<?HTMLInputElement>(null);
...
export const WithTusConcatenation: UploadyStory = createUploadyStory((props): Element<"div"> => {
    const inputRef = useRef<?HTMLInputElement>(null);
...
export const WithFeatureDetection: UploadyStory = createUploadyStory((props): Element<"div"> => {
    const inputRef = useRef<?HTMLInputElement>(null);
